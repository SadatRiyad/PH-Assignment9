...
const About = () => {
    return (
        <div className="container mx-auto px-4 pt-6 pb-4 bg-red text-white">
            ...
            <div data-aos="fade-right" data-aos-duration="700" data-aos-anchor-placement="top-bottom" data-aos-delay="50" className='w-full p-4 h-fit'>
                <div className='w-full h-fit rounded-lg'>
                    <img className='w-full rounded-lg' src={aboutPic} alt="" />
                </div>
            </div>
            <div data-aos="fade-left" data-aos-duration="700" data-aos-anchor-placement="top-bottom" data-aos-delay="900"  className='text-center mt-12 mb-10 mx-1'>
            ...
            <div className="pt-12 px-1">
                <div data-aos="fade-right" data-aos-duration="700" data-aos-anchor-placement="top-down" data-aos-delay="150"  tabIndex={0} className="rounded-b collapse collapse-arrow text-white bg-blue focus:bg-red">
                    <input type="checkbox" />
                ...
                <div data-aos="fade-right" data-aos-duration="700" data-aos-anchor-placement="top-down" data-aos-delay="200" tabIndex={0} className="rounded-none collapse collapse-arrow text-white bg-blue focus:bg-red">
                    <input type="checkbox" />
                    <div className="collapse-title text-xl font-medium">
                ...
                <div data-aos="fade-right" data-aos-duration="700" data-aos-anchor-placement="top-down" data-aos-delay="250"  tabIndex={0} className="rounded-t mb-1 collapse collapse-arrow text-white bg-blue focus:bg-red">
                    <input type="checkbox" />
                    <div className="collapse-title text-xl font-medium">
