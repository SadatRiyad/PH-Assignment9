...
const About = () => {
    return (
        <div className="container mx-auto px-4 pt-6 pb-4 bg-red text-white">
            ...
            <div className='text-center mt-12 mb-10 mx-1'>
            ...
            <div className="pt-12">
                <div tabIndex={0} className="rounded-b collapse collapse-arrow text-white bg-blue focus:bg-red">
                    <input type="checkbox" />
                ...
                <div tabIndex={0} className="rounded-none collapse collapse-arrow text-white bg-blue focus:bg-red">
                    <input type="checkbox" />
                    <div className="collapse-title text-xl font-medium">
                ...
                <div tabIndex={0} className="rounded-t mb-1 collapse collapse-arrow text-white bg-blue focus:bg-red">
                    <input type="checkbox" />
                    <div className="collapse-title text-xl font-medium">
