...
const ContactUs = () => {
    ...
    return (
        <>
            ...
            <div data-aos="zoom-in" data-aos-duration="700" data-aos-anchor-placement="top-bottom" data-aos-delay="50" className="container mx-auto px-4 pt-4 pb-0">
            <img src={contactImg} alt="Contact" className="w-full h-auto rounded-t-xl mb-0" />
            </div>
