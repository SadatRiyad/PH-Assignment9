...
const EstateDtails = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        toast.success("Your tour has been scheduled successfully! We will contact you shortly to confirm the details.")
                ...
                <div className="text-start">
                    <div>
                        <Swiper
                            ...
                            className="mySwiper"
                        >
                            {estateData?.filter(estate => estate.id !== IdInt).map(filteredEstate => (
                                <SwiperSlide key={filteredEstate.id}>
                                    <EstateData key={filteredEstate.id} estateData={filteredEstate} />
                                </SwiperSlide>
                            ))}
