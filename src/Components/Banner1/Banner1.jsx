                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 px-2">
                    <div className="card bg-white shadow-xl rounded-lg overflow-hidden">
                        ...
                        <div className="card-body py-4 px-6">
                            ...
                            <a href="#estate" className="btn bg-red hover:bg-red border-red text-white hover:text-white rounded hover:border-red  hover:-translate-y-1 transition-all duration-200 font-bold mt-4">View More</a>
                        </div>
                    </div>
                    ...
                    <div className="card grow bg-white shadow-xl rounded-lg overflow-hidden">
                        ...
                        <div className="card-body py-4 px-6">
                            ...
                            <a href="#estate" className="btn bg-red hover:bg-red border-red text-white hover:text-white rounded hover:border-red  hover:-translate-y-1 transition-all duration-200 font-bold mt-2">View More</a>
                        </div>
                    </div>
