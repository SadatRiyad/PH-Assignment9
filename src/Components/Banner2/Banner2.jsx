...
const Banner2 = () => {
    return (
        <div className="card mb-20 mt-8 lg:card-side text-white shadow-xl bg-red p-4">
            <div data-aos="fade-right" data-aos-duration="600" data-aos-anchor-placement="top-bottom" data-aos-delay="500"  className="w-full h-full flex lg:w-2/4 items-center justify-center">
                <div>
